        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='flex flex-col md:flex-row gap-4 mb-12'>
                ...
                <div className='md:w-2/3'>
                    <p className='text-secondary md:w-2/3'>At our digital marketing agency, we offer a range of services to help businesses grow and succeed online. These services include:</p>
                </div>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                {
                    servicesData.map((service, index) => (
                        <div key={index} className={`flex flex-col sm:flex-row md:justify-between md:items-ceenter gap-6 p-6 rounded-lg border border-[#191A23] cursor-pointer ${service.backgroundColor} ${service.textColor}`}>
